...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { birth: @name.birth, date: @name.date, house: @name.house, make: @name.make, name: @name.name, of: @name.of }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { birth: @name.birth, date: @name.date, house: @name.house, make: @name.make, name: @name.name, of: @name.of }
    assert_redirected_to name_path(assigns(:name))
  end
